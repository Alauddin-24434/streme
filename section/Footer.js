    ...
    return (
        <div>
            <footer class="bg-[#101010] text-white py-12">
                <div class="container mx-auto flex flex-col md:flex-row lg:flex-row xl:flex-row 2xl:flex-row gap-4 justify-between">
                    <div class="max-w-96 ">
                        <h3 class="text-base ml-2  text-center md:text-lg lg:text-lg xl:text-lg 2xl:text-2xl font-bold mb-4 text-yellow-500 ">About Us</h3>
                    ...
                    <div class="">
                        <h3 class="text-base text-center md:text-lg lg:text-lg xl:text-lg 2xl:text-2xl font-bold mb-4 mt-2 text-yellow-500">Follow Us</h3>
