          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between py-2 items-center">
              ...
              <div className="flex justify-center items-center ">
                ...
                <Link href="/animation">
                  <span className="text-white text-xs md:text-base lg:text-lg xl:text-lg 2xl:text-lg mr-4 cursor-pointer">Animation</span>
                </Link>
                <Link href="/drama">
             ...
             w-full" // Responsive width based on screen size
                  onChange={handleSearch}
                  onKeyDown={handleEnterPress} // Bind the 'Enter' key press handle
                />
