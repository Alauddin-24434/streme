...
const userInfo=useUserInfo()
    ...
    return (
      ...
      <div className="mt-6 mr-3">
        {userInfo &&  userInfo?.isAdmin || userInfo?.isPayment  ?<Link href="/home"><span className="font-bold  py-2 xl:py-3 text-xs md:text-base lg:text-lg xl:text-xl hover:scale-95 duration-300 px-4 lg:px-10 text-white mt-5 bg-[#00b84b] z-[100000]">Lets Enjoy</span></Link> 
