    ...
    return (
        <div className="bg-[#101010] ">
            <div className="max-w-[1400px] md:px-10 mx-auto py-[50px] md:py-[150px]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 2xl:grid-cols-4 items-center space-y-8">
                <h1 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-5xl text-center md:text-left font-bold text-white pl-2 md:pl-16 lg:pl-0 ">Choose the plan that’s right for you</h1>
                    <div className="md:w-[300px] mx-auto space-y-8 relative p-8 bg-[#1D1D1D]">
                        ...
                        <div className="space-y-4 text-white">
                            ...
                            <div className="pt-4 flex justify-center">
                                <button className="w-full hover:bg-green-500 h-16 border-2 border-[#00B84B] text-[#00B84B] font-black rounded-full hover:text-white duration-300 relative group">
                    ...
                    <div className="md:w-[300px] mx-auto space-y-8 relative p-8 bg-[#1D1D1D]">
                        ...
                        <div className="space-y-4 text-white">
                            ...
                            <div className="pt-4 flex justify-center">
                                <button className="w-full h-16 border-2 border-[#00B84B] text-[#00B84B] font-black rounded-full hover:text-white duration-300 hover:bg-green-600 relative group">
                                    <span className="absolute w-12 group-hover:w-[93%] duration-300 flex group-hover:justify-start rounded-full inset-2 bg-[#00B84B] group-hover:[#00B84B] group-hover:duration-500 -z-10"></span>
                                    Purchases
                                </button>
                            </div>
              ...
              /> */}
                        ...
                        <div className="space-y-4 text-white">
                            ...
                            <div className="pt-4 flex justify-center">
                                <button className="w-full h-16 hover:bg-green-500 border-2 border-[#00B84B] text-[#00B84B] font-black rounded-full hover:text-white duration-300 relative group">
                                    <span className="absolute w-12 group-hover:w-[93%] duration-300 flex group-hover:justify-start rounded-full inset-2 bg-[#00B84B] group-hover:[#00B84B] group-hover:duration-500 -z-10"></span>
                                    Purchases
                                </button>
                            </div>
