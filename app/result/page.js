...
const Page = () => {
  ...
  return (
    <div>
      ...
      <div className='flex flex-row-reverse max-w-5xl mx-auto gap-6'>
        <div className="w-full md:w-2/3 shadow mt-3 px-5 rounded-lg bg-white">
          ...
          <div>
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 g mt-4">
              <select className="px-4 py-3 w-40 rounded-md bg-slate-900 border-transparent focus:border-gray-500 focus:bg-gray-800 focus:ring-0 text-sm">
              ...
              <button className="px-4 w-40 py-2 bg-slate-900 hover:bg-gray-200 text-white text-sm font-medium rounded-md">
                Reset Filter
              </button>
            </div>
          </div>
